  ...
  <div class="q-pa-md">
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-2">
            <div class="col-12" style="margin-bottom: 10px">
              <label>No. Register <span style="color: red">*</span> :</label>
              <q-input
                v-model="tmpFormCari.trn_noreg"
                dense
                outlined
                label="No. Register"
              />
          ...
          <div class="col-2">
            <div class="col-12" style="margin-bottom: 10px">
              ...
              <q-select
                dense
                outlined
                v-model="tmpFormCari.trn_kategori"
                emit-value
                map-options
          ...
          <div class="col-2">
            <div class="col-12" style="margin-bottom: 10px">
              ...
              <q-select
                dense
                outlined
                v-model="tmpFormCari.trn_vendor_code"
                use-input
                emit-value
                map-options
          ...
          <div class="col-2">
            <div class="col-12" style="margin-bottom: 10px">
              ...
              <q-select
                dense
                outlined
                v-model="tmpFormCari.trn_jenis_vendor"
                emit-value
                map-options
                option-value="DepartmentCode"
                option-label="DepartmentName"
          ...
          <template v-slot:body-cell-aksi="props">
            <q-td :props="props">
              <q-btn
                ...
                icon="feed"
                size="sm"
                :to="`/econtract-kontrakclose/detail/${props.row.trn_code}`"
    ...
    <q-dialog v-model="dialogForm">
      <q-card style="width: 800px; max-width: 80vw">
        <q-card-section>
          <div class="text-h6">Input Rule & Kelengkapan</div>
        </q-card-section>
        <q-separator />
              ...
              <div class="row">
                <div class="col-12" style="margin-bottom: 10px">
                  ...
                  <q-select
                    dense
                    outlined
                    v-model="tmpForm.kelengkapan_urutan"
                    use-input
                    emit-value
                    map-options
                    input-debounce="0"
            ...
            <div class="col-12">
              <div class="row">
                <div class="col-6" style="margin-bottom: 10px">
                  ...
                  <q-input
                    v-model="tmpForm.kelengkapan_desc"
                    dense
                    outlined
                    label="Keterangan"
                    :rules="[(val) => !!val || 'Field is required']"
                ...
                <div class="col-5" style="margin-bottom: 10px">
                  ...
                  <q-select
                    dense
                    outlined
                    v-model="tmpForm.kelengkapan_status"
                    use-input
                    emit-value
                    map-options
                    input-debounce="0"
...
const columns = [
  ...
  {
    name: "created_by_nama",
    required: true,
    label: "Pic Pembuat",
    align: "left",
    field: "created_by_nama",
    sortable: true,
  },
  {
    name: "trn_kategori",
  ...
  {
    name: "trn_jenis_vendor",
    required: true,
    label: "Jenis Vendor",
    align: "left",
    field: "trn_jenis_vendor",
    sortable: true,
  },
  {
    name: "trn_file_draft_contract",
    required: true,
    label: "Lamp. Perjanjian",
    align: "left",
...
const tmpForm = reactive({
  id: null,
  trn_domain: domain(),
  kelengkapan_urutan: null,
  kelengkapan_desc: null,
  kelengkapan_status: null,
  approval: null,
});
...
const getData = async () => {
  try {
    $q.loading.show();
    const res = await apiEC.get("getKontrakUserClose", {
      params: {
        ...pagination.value,
        nik: nik(),
        trn_domain: tmpFormCari.trn_domain,
        trn_noreg: tmpFormCari.trn_noreg,
        trn_kategori: tmpFormCari.trn_kategori,
        trn_vendor_code: tmpFormCari.trn_vendor_code,
        trn_jenis_vendor: tmpFormCari.trn_jenis_vendor,
        trn_flag: tmpFormCari.trn_flag,
      },
    });
    console.log("getKontrakUser", res.data.data);
...
const saveAplikasi = async () => {
  try {
    for (const rule of validationRules) {
      if (!tmpForm[rule.field] || tmpForm[rule.field] === "") {
        $q.notify({
          type: "negative",
    ...
    $q.loading.show();
    await apiEC.post("saveRule", tmpForm, {
      headers: {
        Authorization: token,
      },
    });
...
const reset = () => {
  ...
  tmpForm.kelengkapan_urutan = null;
  tmpForm.kelengkapan_desc = null;
  tmpForm.kelengkapan_status = null;
};
