<template>
  <div class="q-pa-lg">
    ...
    <q-card maximized>
      <q-card-section>
        <div class="text-h6">Detail Kontrak {{ tmpForm.trn_code }}</div>
      </q-card-section>
      <q-separator />
      <!-- <q-card-section maximized class="scroll"> -->
      <q-card-section maximized>
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <div class="row">
              <div class="col-12" style="margin-bottom: 10px">
                <label
                  >Pengajuan Kontrak <span style="color: red">*</span> :</label
                >
                <q-select
                  dense
                  outlined
                  v-model="tmpForm.trn_pengajuan"
                  use-input
                  emit-value
                  map-options
                  input-debounce="0"
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                ...
                >
                <q-input
                  v-model="tmpForm.trn_mengajukan"
                  dense
                  outlined
                  label="Mengajukan untuk pembuatan"
                  :rules="[(val) => !!val || 'Field is required']"
                  counter
                  maxlength="200"
                  readonly
            ...
            <div class="row q-col-gutter-lg">
              <div class="col-6" style="margin-bottom: 10px">
                ...
                <q-input
                  ...
                  outlined
                  label="Tanggal Mulai"
                  v-model="tmpForm.trn_date_start"
                  mask="##/##/####"
                  fill-mask="#"
                  readonly
                >
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <div class="col-12" style="margin-bottom: 10px">
              ...
              <q-select
                dense
                outlined
                v-model="tmpForm.trn_vendor_code"
                use-input
                emit-value
                map-options
                option-value="sup_code_app"
                option-label="sup_name"
                input-debounce="0"
                label="Select Departemen"
                :options="listVendorAllOriginal"
                @update:model-value="handleSelectVendor"
                @filter="filterFnVendor"
                :rules="[(val) => !!val || 'Field is required']"
                readonly
              >
                <template v-slot:no-option>
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                ...
                <q-input
                  v-model="tmpForm.trn_vendor_address"
                  dense
                  outlined
                  label="Alamat Vendor"
                  :rules="[(val) => !!val || 'Field is required']"
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label
                  >Nama Pendatangan Kontak
                  <span style="color: red">*</span> :</label
                >
                <q-input
                  v-model="tmpForm.trn_vendor_pendatangan_name"
                  dense
                  outlined
                  label="Nama Pendatangan Kontak"
                  :rules="[(val) => !!val || 'Field is required']"
                  readonly
                />
              </div>
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label
                  >Email Pendatangan Kontak
                  <span style="color: red">*</span> :</label
                >
                <q-input
                  v-model="tmpForm.trn_vendor_pendatangan_email"
                  dense
                  outlined
                  label="Email Pendatangan Kontak"
                  :rules="[(val) => !!val || 'Field is required']"
                  readonly
                />
              </div>
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label
                  >Jabatan Pendatangan Kontak
                  <span style="color: red">*</span> :</label
                >
                <q-input
                  v-model="tmpForm.trn_vendor_pendatangan_jabatan"
                  dense
                  outlined
                  label="Jabatan Pendatangan Kontak"
                  :rules="[(val) => !!val || 'Field is required']"
                  readonly
                />
              </div>
          ...
          <div class="col-2">
            <div class="row">
              <div class="col-12">
                ...
                <q-input
                  v-model="tmpForm.trn_vendor_rekno"
                  dense
                  outlined
                  label="No. Rekening"
                  :rules="[(val) => !!val || 'Field is required']"
          ...
          <div class="col-2">
            <div class="row">
              <div class="col-12">
                ...
                <q-input
                  v-model="tmpForm.trn_vendor_rekname"
                  dense
                  outlined
                  label="Nama Rekening"
                  :rules="[(val) => !!val || 'Field is required']"
          ...
          <div class="col-2">
            <div class="row">
              <div class="col-12">
                ...
                <q-input
                  v-model="tmpForm.trn_vendor_rekbank"
                  dense
                  outlined
                  label="Nama Bank"
                  :rules="[(val) => !!val || 'Field is required']"
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label
                  >Kantor Cabang Bank <span style="color: red">*</span> :</label
                >
                <q-input
                  v-model="tmpForm.trn_vendor_rekcabang"
                  dense
                  outlined
                  label="Kantor Cabang"
                  :rules="[(val) => !!val || 'Field is required']"
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label
                  >Garansi Pekerjaan Jasa
                  <span style="color: red">*</span> :</label
                >
                <q-input
                  v-model="tmpForm.trn_garansi"
                  dense
                  outlined
                  label="Garansi Pekerjaan Jasa"
                  :rules="[(val) => !!val || 'Field is required']"
                  counter
                  maxlength="150"
                  readonly
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label
                  >Catatan Pricing <span style="color: red">*</span> :</label
                >
                <q-input
                  v-model="tmpForm.notes"
                  dense
                  outlined
                  label="Catatan Pricing"
                  :rules="[(val) => !!val || 'Field is required']"
                  counter
                  maxlength="150"
                  readonly
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12" style="margin-bottom: 10px">
                <label>Jenis Vendor <span style="color: red">*</span> :</label>
                <q-select
                  dense
                  outlined
                  v-model="tmpForm.trn_jenis_vendor"
                  use-input
                  emit-value
                  map-options
                  option-value="trn_jenis_vendor"
                  option-label="trn_jenis_vendor"
                  input-debounce="0"
                  label="Select jenis vendor"
                  :options="listJenisVendor"
                  :rules="[(val) => !!val || 'Field is required']"
                  readonly
                >
                  <template v-slot:no-option>
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <div class="row">
              <div class="col-12" style="margin-bottom: 10px">
                <label
                  >Apakah pernah ada isu K3?
                  <span style="color: red">*</span> :</label
                >
                <q-select
                  dense
                  outlined
                  v-model="tmpForm.trn_aspek_k3"
                  use-input
                  emit-value
                  map-options
                  option-value="k3"
          ...
          <div class="col-6">
            <div class="row">
              <div class="col-12" style="margin-bottom: 10px">
                <label>Catatan K3 :</label>
                <q-input
                  v-model="tmpForm.trn_aspek_desc"
                  dense
                  outlined
                  label="Catatan k3"
                  type="textarea"
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label>Pembayaran 1 <span style="color: red">*</span> :</label>
                <q-input
                  v-model="tmpForm.trn_pembayaran_1"
                  dense
                  outlined
                  label="Pembayaran 1"
                  :rules="[(val) => !!val || 'Field is required']"
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-12">
                <label>Pembayaran 2 <span style="color: red">*</span> :</label>
                <q-input
                  v-model="tmpForm.trn_pembayaran_2"
                  dense
                  outlined
                  label="Pembayaran 2"
                  :rules="[(val) => !!val || 'Field is required']"
          ...
          <div class="col-2">
            <div class="row">
              <div class="col-12">
                <label>Pembayaran 3 :</label>
                <q-input
                  v-model="tmpForm.trn_pembayaran_3"
                  dense
                  outlined
                  label="Pembayaran 3"
                  counter
          ...
          <div class="col-2">
            <div class="row">
              <div class="col-12">
                <label>Pembayaran 4 :</label>
                <q-input
                  v-model="tmpForm.trn_pembayaran_4"
                  dense
                  outlined
                  label="Pembayaran 4"
                  counter
          ...
          <div class="col-2">
            <div class="row">
              <div class="col-12">
                <label>Pembayaran 5 :</label>
                <q-input
                  v-model="tmpForm.trn_pembayaran_5"
                  dense
                  outlined
                  label="Pembayaran 5"
                  counter
      ...
      <q-card-section>
        <q-list>
          <q-item
            ><q-item-section class="col-1" style="font-size: 18px">
              Rules :
            </q-item-section>
      ...
      <q-card-section>
        <div class="row q-col-gutter-lg">
          <div class="col-3">
            <label>No Tiket HDS :</label>
            <q-input
              v-model="tmpForm.trn_notiket_hds"
              dense
              outlined
              label="No Tiket HDS"
              counter
          ...
          <div class="col-3">
            <label>&nbsp;</label>
            <p
              v-if="tmpForm.trn_notiket_hds"
              @click="cekTiket(tmpForm.trn_notiket_hds)"
              class="tw-font-semibold tw-text-blue-500 tw-cursor-pointer"
            >
              Cek progress tiket HDS Legal
            </p>
          </div>
        </div>
        <div class="row q-col-gutter-lg">
        ...
        <div class="row q-col-gutter-lg">
          <div class="col-12">
            ...
            <p
              v-if="tmpForm.trn_file_fix_contract_lama"
              @click="download(tmpForm.trn_file_fix_contract_lama)"
              class="tw-font-semibold tw-text-blue-500 tw-cursor-pointer"
            >
      ...
      <q-card-actions align="right">
        <q-btn push color="primary" to="/econtract-kontrakvendor" icon="undo"
          ><q-tooltip class="bg-primary text-body2" :offset="[10, 10]">
            Back to list kontrak user
          </q-tooltip></q-btn
        >
        <q-btn
          :disable="tmpForm.trn_file_fix_contract_lama === ''"
          push
          color="info"
          icon="picture_as_pdf"
          :to="`/econtract-kontrakvendor/print/${routerParams.params.no_code}`"
    ...
    <q-card>
      <q-card-section>
        <h3 style="font-size: 18px">List user vendor</h3>
        <q-table
          title="List Kontak Vendor"
    ...
    <q-card>
      <q-card-section>
        <h3 style="font-size: 18px">List pic vendor</h3>
        <q-table
          title="List Kontak Vendor"
          :rows="listPicUser"
            ...
            <div class="row q-col-gutter-sm">
              <div class="col-12">
                <q-select
                  ...
                  dense
                  debounce="300"
                  v-model="pagination2.rowsPerPage"
                  :options="[5, 10, 25, 50, 100, 200]"
                  @update:modelValue="updateTable2"
                >
                  <template v-slot:before>
                    <q-icon name="reorder">
                      <q-tooltip :class="'tw-bg-black/90'">
    ...
    <q-card>
      <q-card-section>
        <div class="text-h6">Dokumen {{ tmpForm.trn_jenis_vendor }}</div>
      </q-card-section>
      <q-separator />
      <q-card-section>
        <!-- <q-card-section maximized class="scroll"> -->
        <div class="col-12">
          <q-form>
            <q-card-section>
              <q-list>
                <q-item style="background-color: red; color: antiquewhite"
                  ...
                  <q-item-section class="col-4"> Download </q-item-section>
                </q-item>
                <q-item
    ...
    <q-card maximized>
      <q-card-section>
        <div class="text-h6">Dokumen Lampiran Perjanjian</div>
      </q-card-section>
      <q-separator />
      <!-- <q-card-section maximized class="scroll"> -->
      <div class="col-12">
        <q-form>
          <q-card-section>
            <q-list>
              <q-item style="background-color: red; color: antiquewhite"
                ><q-item-section class="col-1 text-center"> No </q-item-section>
                <q-item-section class="col-3"> Dokumen </q-item-section>
                <q-item-section class="col-4"> Keterangan </q-item-section>
                <q-item-section class="col-4"> Download </q-item-section>
              </q-item>
              ...
              >
                ...
                <q-item-section class="col-4">
                  <p
                    v-if="item.perjanjian_file_upload"
                    @click="download(item.perjanjian_file_upload)"
                    class="tw-font-semibold tw-text-blue-500 tw-cursor-pointer"
                  >
                    {{ item.perjanjian_file_asli }}
                  </p>
                </q-item-section>
              </q-item>
            </q-list>
...
const addAplikasi = async () => {
  ...
  try {
    ...
    router.push(`/econtract-kontrakvendor/`);
