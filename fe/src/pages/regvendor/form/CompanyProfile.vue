        ...
        <q-card class="my-card">
            ...
            <q-card-section class="q-mx-xs">
                <div class="q-mt-sm q-mb-sm q-mb-md">
                    <span class="text-indigo-10 tw-text-xl text-bold">FORM COMPANY PROFILE</span>
                </div>
...
const getFile = async () => {
    try {
        $q.loading.show();
        const res = await axios.get("getCompanyProfile", {
            params: {
                ...pagination.value,
                code: route.params.code,
            },
...
const saveFile = async () => {
    try {
        ...
        if(tmpData.file == ''){
            ...
            const res = await axios.post("saveCompanyProfile", tmpData, {
                headers: {
